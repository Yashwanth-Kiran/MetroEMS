...
class TranscoderDriver(DeviceDriver):
    vendor = "generic-transcoder"
    ...
    def identify(self, ip: str, c: str = "public") -> Dict[str, Any]:
        ...
        match = False
        if isinstance(sysdescr, str) and any(k in sysdescr.lower() for k in ["transcoder", "codec", "encoder/decoder"]):
            match = True
